    ...
    pub fn draw(&mut self, _color: Rgb, alpha: f32) {
        ...
        unsafe {
            ...
            for index in indicies {
                ...
                // 画像を切り取る領域の座標（ピクセル）
                let (image_center_x, image_center_y) =
                    (image.image_width as f32 / 2.0, image.image_height as f32 / 2.0);
                let (bottom_left_x, bottom_left_y) = (
                    image_center_x - terminal_logical_width / 2.0,
                    image_center_y - terminal_logical_height / 2.0,
                );
                ...
                let (bottom_left_u, bottom_left_v) = (
                    bottom_left_x / image.image_width as f32,
                    bottom_left_y / image.image_height as f32,
                );
                let (top_right_u, top_right_v) = (
                    top_right_x / image.image_width as f32,
                    top_right_y / image.image_height as f32,
                );
